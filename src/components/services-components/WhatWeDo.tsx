const WhatWeDo = () => {
  return (
    <div className="whatWeDo_bg">
      <div className="flex flex-col md:flex-row items-center justify-center gap-[16px] md:gap-[64px] bg-[#FFFFFF] px-[14px] md:px-0 py-[40px] md:py-[80px] max-w-[1300px] mx-auto">
        <div className="flex flex-col border border-[#800080] rounded-[16px] px-[32px] md:px-[62px] py-[32px] md:py-[78px] mx-auto w-full md:max-w-[524px] bg-red-200">
        ...
        <div className="flex flex-col border border-[#800080] rounded-[16px] px-[32px] md:px-[62px] py-[32px] md:py-[78px] w-full md:max-w-[524px] bg-red-500">
