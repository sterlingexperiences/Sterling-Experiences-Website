const Header = () => {
  return (
    <div className="flex items-center justify-center flex-col">
      <h1 className="font-ebGaramond text-[36px] md:text-[56px] font-[600] leading-[43px] md:leading-[78px] text-[#800080] mt-[60px] tracking-[-0.04em] text-center md:text-left">
        We Create Sterling Experiences
      </h1>
      <p className="font-openSans text-[18px] text-[#0E0E12] leading-[25px] tracking-[-0.02em] mt-[20px] md:px-[100px]">
      ...
      <p className="font-openSans text-[18px] text-[#0E0E12] leading-[25px] tracking-[-0.02em] mt-[40px] md:px-[100px]">
